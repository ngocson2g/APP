...
class CommandRunner(Protocol):
    ...
    def __call__(self, cmd: str, settings: Settings, check_text: str | None) -> CmdResult: ...

def default_command_runner(cmd: str, settings: Settings, check_text: str | None) -> CmdResult:
    """Triển khai mặc định: gọi core.command.run_command."""
    return _default_run_command(cmd, settings, check_text)
