...
do
    ...
    ( /usr/bin/time security-app data/canonical_ubuntu_24.04_lts.csv ) 2>> "$LOG_FILE"
    
    echo "Hoàn thành lần $i."
done

echo "Đã chạy xong 10 lần. Kết quả được lưu tại: $LOG_FILE"
